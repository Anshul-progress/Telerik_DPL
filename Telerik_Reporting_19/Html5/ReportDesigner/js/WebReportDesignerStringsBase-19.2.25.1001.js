 export class WebReportDesignerStringsBase  {
    constructor() { 
        ...
        this.GraphQLDataSource = "GraphQL Data Source";
        ...
        this.AIDescription = "AI description";
        ...
        this.SQLDataCommandSchemaRestrictionsHeader = "Schema restrictions";
        this.SQLDataCommandSchemaRestrictionsTooltip = "Comma-separated set of case-sensitive restriction values for the columns of the requested schema.";
        ...
        this.PreviewWaitingMessageQL = "No data available";
        this.WrongDataSelectorMessageQL = "Data selector did not produce any significant result";
        this.GraphQLDataSourceServiceUrlPlaceholder = "Data Selector";
        this.HideLink = "Hide";
        this.ShowAllLink = "Show All";
        this.GraphQLDataSourceSettings = "GraphQL settings";
        ...
        this.ClosingWillResultInLoss = `'{documentId}' has unsaved changes. Close and discard changes?`;
        ...
        this.EditorToolbarInsertNewLine = "Insert new line";
        ...
        this.DataSourceDialogMismatch = "mismatch";
        this.DataSourceDialogMismatchTitle = "Data Source Mismatch";
        this.DataSourceDialogWarning = "warning";
        this.DataSourceDialogWarningTitle = "Data Source Warning";
        this.DataSourceDialogConfirmation = "confirmation";
        this.DataSourceDialogConfirmationTitle = "Set Data Source";
        this.DataSourceDialogMismatchMessage = "You are trying to add a field from data source '{0}' to '{1}' which already uses data source '{2}'. Using fields from different data sources is not permitted.";
        this.DataSourceDialogWarningMessage = "The '{0}' contains tables, crosstabs or lists that may have their own data sources. Setting '{1}' as the '{2}'\'s data source may lead to unexpected results when combined with the data sources of the nested items. Do you wish to proceed?";
        this.DataSourceDialogConfirmationMessage = "The container '{0}' has no data source. Would you like to set '{1}' as its data source?";
    }
}
